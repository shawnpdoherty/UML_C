...
Homework 5 (Structures) Multiple File Code Template
---------------------------------------------------

This folder contains template files to allow you to complete Homework 5 (Structures)
in the C Programming class using multiple files.   See Option 1 folder for homework
template files needed using a Call by Reference design.  See Option 2 folder for
homework template files needed for a design that implements functions with a combination of Call by Value and Call by Reference.
...
provided to get you started.   Just run make to start:
